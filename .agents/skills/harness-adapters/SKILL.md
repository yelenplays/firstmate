...
When a secondmate is launched on Pi or pi-signed, `fm-spawn.sh --secondmate` passes that home's own tracked extensions with `-e`; [`docs/configuration.md`](../../../docs/configuration.md#harness-support) owns the exact set it launches.
