...
Bypass only pure control messages (harness slash commands, operational injection markers), single acknowledgments, credential or secret submissions (which never go to any tool), and routine monitoring traffic.
