...
- `ambiguous`: offer the listed wikis as a choice and load nothing until one is picked.
  ...
  The same local route relevance floor applies when an authorized full-access selection descends pages; below-floor ranking preserves the selected declaration.
