...
state/               volatile runtime signals; gitignored
  ...
  <id>.claude-settings-backup  what the worktree's .claude/settings.local.json looked like before the Claude turn-end hook was merged in, so teardown can restore it; removed by teardown
