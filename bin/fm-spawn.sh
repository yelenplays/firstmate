...
launch_template() {
  ...
  # The prompt also carries the advisory, fail-open Jev-first rule for closed-set
  # judgments; bin/fm-brief.sh writes the identical sentences into every ship and
  # scout brief's Rules, so edit both together.
  claude)
