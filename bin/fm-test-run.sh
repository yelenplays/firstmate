...
tests/fm-afk-return.test.sh 1089
tests/fm-ask-user-authority.test.sh 63
tests/fm-backend-cmux-smoke.test.sh 28
tests/fm-backend-cmux.test.sh 2501
tests/fm-backend-herdr-focus-flash-e2e.test.sh 21
tests/fm-backend-orca.test.sh 13234
tests/fm-backend-tmux-smoke.test.sh 321
tests/fm-backend-zellij-smoke.test.sh 21
tests/fm-backend-zellij.test.sh 5021
tests/fm-backend.test.sh 16540
tests/fm-backlog-handoff.test.sh 3199
tests/fm-bearings-snapshot.test.sh 62470
tests/fm-bootstrap.test.sh 23218
tests/fm-busy-adapter-wiring.test.sh 14014
tests/fm-busy-state.test.sh 650
tests/fm-calm-pi-extension.test.sh 329
tests/fm-claude-stop-autoarm-live-e2e.test.sh 20
tests/fm-claude-stop-autoarm.test.sh 60566
tests/fm-codex-continuity-live-e2e.test.sh 19
tests/fm-daemon.test.sh 15403
tests/fm-documentation-audiences.test.sh 591
tests/fm-fleet-snapshot-view.test.sh 6233
tests/fm-fleet-sync.test.sh 14806
tests/fm-gate-refuse.test.sh 3107
tests/fm-gitignore-config.test.sh 30
tests/fm-gotmp.test.sh 349
tests/fm-grok-continuity-live-e2e.test.sh 19
tests/fm-grok-stop-live-e2e.test.sh 21
tests/fm-guard-stale-banner.test.sh 3382
tests/fm-harness-liveness-drift-live-e2e.test.sh 19
tests/fm-herdr-session-cleanup.test.sh 4904
tests/fm-kimi-harness.test.sh 12861
tests/fm-on.test.sh 436
tests/fm-opencode-primary-live-e2e.test.sh 22
tests/fm-operational-input.test.sh 184
tests/fm-pending-reply.test.sh 7612
tests/fm-pi-primary-live-e2e.test.sh 18
tests/fm-pi-watch-extension.test.sh 16819
tests/fm-pr-check-security.test.sh 205592
tests/fm-procevent.test.sh 48129
tests/fm-public-followup.test.sh 25152
tests/fm-quota-array-dispatch-live-e2e.test.sh 21
tests/fm-remote-backlog-handoff.test.sh 10516
tests/fm-remote-reply.test.sh 5212
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 49117
tests/fm-remote-secondmate-trace-context.test.sh 10457
tests/fm-secondmate-harness.test.sh 95455
tests/fm-secondmate-lifecycle-e2e.test.sh 5393
tests/fm-secondmate-liveness.test.sh 14088
tests/fm-secondmate-safety.test.sh 28307
tests/fm-secondmate-sync.test.sh 13882
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 28
tests/fm-send-secondmate-marker.test.sh 2383
tests/fm-session-lock-ancestry.test.sh 1144
tests/fm-session-start.test.sh 38021
tests/fm-sessionstart-nudge.test.sh 279
tests/fm-shared-captain-inheritance.test.sh 4018
tests/fm-spawn-dispatch-profile.test.sh 41890
tests/fm-spawn-worktree-settle.test.sh 4643
tests/fm-startup-memory-budget.test.sh 4591
tests/fm-subagent-pretool-check.test.sh 971
tests/fm-supervision-events.test.sh 428
tests/fm-tangle-guard.test.sh 9425
tests/fm-task-delivery.test.sh 1452
tests/fm-teardown-endpoint-safety.test.sh 1242
tests/fm-teardown.test.sh 31277
tests/fm-test-isolation-proof.test.sh 365
tests/fm-tmux-agent-liveness.test.sh 613
tests/fm-trace-context-lib.test.sh 193
tests/fm-trace-context-spawn.test.sh 32584
tests/fm-turnend-guard.test.sh 16204
tests/fm-update.test.sh 3098
tests/fm-vendor-auth-probe.test.sh 42818
tests/fm-wake-daemon-lifecycle-e2e.test.sh 4411
tests/fm-wake-queue.test.sh 23500
tests/fm-watch-arm.test.sh 26945
tests/fm-watch-checkpoint.test.sh 4067
tests/fm-watch-triage.test.sh 130346
tests/fm-watcher-lock.test.sh 100191
EOF
}
