...
FM_BROWSER_BRIDGE_TMP_ROOTS=   # test hook: extra ':'-separated canonical temporary roots the browser bridge sweep may remove a profile directory under
