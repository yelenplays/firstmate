...
| `fm-wake-triage.sh`      | Drain, then mark each task's wakes ACT NOW or ROUTINE by one rule (verifiably working, no open decision, no hold), and auto-acknowledge when all are routine |
