...
| Claude | 2.1.282 (Claude Code) | Session list `claude agents --json`, read by the classifier before the hook record | See [Claude session list](#claude-session-list-2026-09-24). |
