...
fm_test_sanitize_environment() {
  unset FM_HOME FM_STATE_OVERRIDE FM_DATA_OVERRIDE FM_ROOT_OVERRIDE \
    ...
    FM_JEV_STATUS_TRIAGE_BIN FM_JEV_WEDGE_CHECK_BIN FM_JEV_SUPERVISION_TIMEOUT_SECS \
    FM_JEV_SUPERVISION_NOUL_FLOOR FM_JEV_SPAN_TRIAGE_MAX \
    FM_JEV_SUPERVISION_CYCLE_BUDGET_SECS \
