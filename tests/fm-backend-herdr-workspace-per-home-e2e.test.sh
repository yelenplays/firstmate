...
printf 'e2e routing summary\n' > "$PRIMARY_HOME/data/cm1/megamind-request.md"
...
printf 'e2e routing summary\n' > "$SM_HOME/data/cm2/megamind-request.md"

# Each home clears its OWN Megamind binding before its worker gets an endpoint,
# so the secondmate-shaped home binds itself rather than inheriting the primary's.
