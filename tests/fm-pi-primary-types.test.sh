...
cp "$ROOT/.pi/extensions/fm-primary-megamind.ts" "$TMP_ROOT/fm-primary-megamind.ts"
cp "$ROOT/.pi/extensions/lib/fm-megamind-offer-picker.ts" "$TMP_ROOT/lib/fm-megamind-offer-picker.ts"
